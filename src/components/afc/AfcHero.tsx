...
export function AfcHero() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_42%,rgba(211,32,46,0.18),transparent_24%),linear-gradient(180deg,rgba(3,4,6,0.20)_0%,rgba(3,4,6,0.18)_38%,rgba(3,4,6,0.86)_83%,#030406_100%)]" />
      ...
      <div className="relative mx-auto grid min-h-[690px] w-[min(1180px,calc(100%-32px))] place-items-center py-12 text-center md:min-h-[742px] lg:min-h-[682px]">
        <div className="mt-4 flex max-w-4xl flex-col items-center">
          ...
          <h1
            id="afc-hero-title"
            className="mt-3 text-balance text-3xl font-black uppercase leading-[1.04] text-white drop-shadow-[0_8px_30px_rgba(0,0,0,0.9)] md:text-5xl lg:text-6xl"
          >
            Sé parte de la élite.
          </h1>
          <p className="mt-4 max-w-2xl text-sm font-semibold leading-7 text-white/[0.70] md:text-base">
          ...
          <span className="mt-7 block h-0.5 w-24 bg-afc-red shadow-[0_0_26px_rgba(211,32,46,0.72)]" />
        </div>
      </div>
    </section>
  );
